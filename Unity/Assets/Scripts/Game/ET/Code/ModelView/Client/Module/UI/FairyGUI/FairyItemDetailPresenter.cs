...
namespace ET.Client
{
    [FairyUIPresenter(UGFUIFormId.FairyItemDetailForm)]
    [global::ET.EnableClass]
    public sealed class FairyItemDetailPresenter : IFairyUIPresenter
    {
        ...
        public void OnOpen(object userData)
        {
            ...
            m_View.DescriptionText.text = global::GameFramework.Utility.Text.Format("{0}\n点击窗口主体可拖动，单击会置顶。", item.Description);
